...
{{--        <div class="col-md-12 form-horizontal">
        ...
        <div class="col-md-12 form-horizontal">
            <div class="form-group ">
                ...
                <div class="col-sm-9">
                    <input type="text" id="full-name" name="full_name" placeholder="Full Name" class="col-xs-10 col-sm-5" />
                </div>
            </div>
        </div>
{{--        <div class="col-md-12 form-horizontal">
        ...
        <div class="col-md-12">
            <table class="table table-bordered" id="education_table">
                ...
                @else
                    <tr>
                        <td>
                            <input type="text" name="education[1][degree]" class="form-control degree" />
                        </td>
                        <td>
                            <input type="text" name="education[1][institute]" class="form-control institute" />
                        </td>
                        <td>
                            <input type="text" name="education[1][result]" class="form-control result" />
                        </td>
                        <td>
                            <input type="text" name="education[1][year]" class="form-control year" />
                        </td>
                        <td>
                            <button type="button" class="btn btn-sm btn-danger remove">-</button>
                        </td>
